...
//-----------------------------------------------------------------------------------
#define FIREBASE_HOST "pet-tracking-8776a-default-rtdb.firebaseio.com"
#define FIREBASE_AUTH "FnEogUnV34QhOxfthLLRXQNwUw2da2zzIbVAEvby"
#define WIFI_SSID "@KisetsuAki"
#define WIFI_PASSWORD "red52horizon"
//-----------------------------------------------------------------------------------
